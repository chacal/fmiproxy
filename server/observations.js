...
module.exports = function(apiKey) {
  function observationUrl(geoid) {
    return 'http://data.fmi.fi/fmi-apikey/' + apiKey + '/wfs?request=getFeature&storedquery_id=fmi::observations::weather::multipointcoverage&geoid=' + geoid + '&parameters=temperature,windspeedms,windgust,winddirection,pressure'
  }

  return {

    getObservationsForGeoid: function(geoid) {
      return request.getAsync(observationUrl(geoid))
